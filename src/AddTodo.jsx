          ...
          <div className='col-md-4'>
            <div className='panel panel-default'>
                ...
                <div className='panel-body'>
                    <form>
                        <div className='form-group'>
                            ...
                            <textarea value={this.state.inputText} onChange={this.updateTextInput} name='todoText' type='text' className='create-todo-text form-control'></textarea>
                            <label style={margin}>How much of a priority is this?</label>
                            <select name='todoPriority' onChange={this.updateSelectedOption} id="prioritySelect" className='create-todo-priority btn-block'>
                ...
                <div className='panel-footer'>
                    <button onClick={() => this.handleClick()} type='button' className='create-todo btn btn-success btn-block'>Add</button>
                </div>
            </div>
          </div>
        )
